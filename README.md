<picture>
  <source media="(prefers-color-scheme: dark)" srcset="header-v2.svg">
  <source media="(prefers-color-scheme: light)" srcset="header-v2.svg">
  <img src="header-v2.svg" width="100%" alt="ALEXIAN">
</picture>
